"""example of RARE method"""

from param_parser import parameter_parser
from utils import tab_printer #load_graph,read_graph
from RoleAwareRandomWalk import RoleBased2Vec  ####
...
def get_node_embedding(args,G,r,t):
    import time
    start0 = time.time()
    print('get embedding time:')
    model = RoleBased2Vec(args, G, r,t, num_walks=10, walk_length=80, window_size=10)
...
if __name__ == "__main__":
    ...
    G = read_graph(path)
    #
    X = get_node_embedding(args, G, r=4,t=0.25)
